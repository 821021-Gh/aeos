...
| AEOS-ARCH-002 | Enterprise Governance Architecture |架構| AEOS-ARCH-001（Approved） | Approved |
| AEOS-ARCH-003 | Architecture Decision Record System |架構| AEOS-ARCH-001（Approved） | Approved |
| AEOS-ARCH-004 | AI Enterprise Architecture Overview | Enterprise Architecture 入口文件 | AEOS-ARCH-001（Approved） | Approved |
| AEOS-ARCH-005 | Platform Architecture |架構| AEOS-ARCH-001（Approved）、AEOS-ARCH-004（Approved） | Approved |
| AEOS-ARCH-006 | Layer Architecture |架構| AEOS-ARCH-001（Approved）、AEOS-ARCH-004（Approved） | Approved |
| AEOS-ARCH-007 | Capability Architecture |架構| AEOS-ARCH-001（Approved）、AEOS-ARCH-004（Approved） | Approved |
| AEOS-ARCH-008 | Repository Architecture |架構| AEOS-ARCH-001（Approved）、AEOS-ARCH-004（Approved） | Approved |
| AEOS-ARCH-009 | Dependency Architecture |架構| AEOS-ARCH-001（Approved）、AEOS-ARCH-004（Approved） | Approved |
| AEOS-ARCH-010 | Workspace Architecture |架構| AEOS-ARCH-001（Approved）、AEOS-ARCH-004（Approved） | Approved |
| AEOS-ARCH-011 | Enterprise Meta Architecture |架構| AEOS-ARCH-004、AEOS-ARCH-006 | Approved |
| AEOS-ARCH-012 | Architecture Principles |架構| AEOS-ARCH-004 | Approved |
| AEOS-ARCH-013 | Enterprise AI Agent Architecture | 架構 | AEOS-ADR-003、AEOS-ARCH-001（Approved）、AEOS-ARCH-004（Approved）、AEOS-ARCH-005（Approved）、AEOS-ARCH-006（Approved）、AEOS-ARCH-007（Approved）、AEOS-ARCH-009（Approved）、AEOS-ARCH-010（Approved）、AEOS-ARCH-012（Approved） | Approved |
| AEOS-ARCH-014 | Productizable Platform Architecture | 架構 | AEOS-ADR-004、AEOS-ARCH-001（Approved）、AEOS-ARCH-005（Approved）、AEOS-ARCH-006（Approved）、AEOS-ARCH-007（Approved）、AEOS-ARCH-009（Approved）、AEOS-ARCH-010（Approved）、AEOS-ARCH-012（Approved）、AEOS-ARCH-013（Approved） | Approved |
...
| AEOS-ARCH-011 — Enterprise Meta Architecture |架構| Enterprise Meta Architecture 定義（AEOS-ARCH-001 §4.2） |
| AEOS-ARCH-012 — Architecture Principles |架構| Architecture Principles 定義（AEOS-ARCH-001 §4.6） |
| AEOS-ARCH-014 — Productizable Platform Architecture | Architecture | Productization Boundary 與能力提升正式架構載體 |
