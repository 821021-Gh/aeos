...
| 建立日期 | 2026-08-05 |
| 最後更新 | 2026-08-07 |
| 依據文件 | AEOS-ADR-002（WA-001 Fact Authority Transition）、AEOS-ADR-001（Approved 1.0.0）、AEOS-ARCH-011（Approved 1.0.0）、AEOS-ARCH-012（Approved 1.0.0） |
| 關聯文件 | EWO-AEOS-0001、AEOS-ADR-001、AEOS-ADR-002、WA-001（歷史來源） |
