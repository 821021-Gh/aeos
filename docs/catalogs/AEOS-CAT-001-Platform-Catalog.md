...
| 建立日期 | 2026-08-06 |
| 最後更新 | 2026-08-06 |
| 依據文件 | EWO-AEOS-0024、AEOS-STD-006（Approved 1.0.0）、AEOS-ARCH-004（Approved 1.0.0）、AEOS-ARCH-005（Approved 1.0.0）、AEOS-ARCH-001、WA-001（Approved v1.0.0） |
| 關聯文件 | AEOS-ARCH-001、AEOS-ARCH-004、AEOS-ARCH-005、AEOS-STD-001～AEOS-STD-006、WA-001 |
