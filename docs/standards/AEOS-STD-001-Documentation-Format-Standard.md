...
| 版本 | 日期 | 變更摘要 | 作者 |
|------|------|----------|------|
| 1.2.0 | 2026-08-22 | 依 EWO-AEOS-0043 補強 §6.2 Language and Narrative Documentation：明確規定 Repository Markdown 與敘述性文件使用繁體中文，並界定必要英文技術名詞、程式碼、API、檔名、命令、識別碼與外部標準原名之保留範圍；SR-AEOS-0043-R1 記錄生命週期修正，SR-AEOS-0043-R2 APPROVED | Codex |
